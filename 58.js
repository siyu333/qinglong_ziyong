...
let userCookie = ($.isNode() ? process.env.wbtcCookie : $.getdata('wbtcCookie')) || 'PPU=UID=80509180067852&UN=4jp7ndpus&TT=672ce610f0290aa34a2a9e78c1db34e2&PBODY=gfw1FhYsP1XmPO3arETExXCbUgLvHPZJMMScBA6RczbNm9diXmMkw4h4PJRVnnwbsym_47X9f_T8RmWU_CcJ_lrhh9BqP27COdL1Ep9-n3p32Z6onTe9L3LHnXf9xjiHoIFALiDR4IMbW71RvdsxqdcVGkhh6DqQg3R6_tmu4k0&VER=1&CUID=IJVaWS3i9KjjAqll7Srfqg#1';
let userUA = ($.isNode() ? process.env.wbtcUA : $.getdata('wbtcUA')) || 'Mozilla/5.0 (Linux; U; Android 9; Redmi Note 5 Build/PKQ1.180904.001; wv) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/534.30';
let userCookieArr = []
let userList = []
